...
map.getView().fit([11825095.292885, 2394263.856669, 11883419.760606, 2421740.412272], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Bản đồ thông tin du lịch thành phố Chí Linh, tỉnh Hải Dương</h2>';
        return titleElement;
    })(),
